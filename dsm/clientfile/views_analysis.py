...
from .views_clients import build_formatters_by_col
import pandas as pd
from .charts import *
import json
...
def is_ajax(request:WSGIRequest):
...
def ajax_chart(request):
    ...
    context = {
        ...
        "pie_potential_level": get_chart(df, "pie_potential_level"),
        "pie_dept": get_chart(df, "pie_dept"),
        "bar_dept_potential": get_chart(df, "bar_dept_potential"),
        "pie_hpaccess": get_chart(df, "pie_hpaccess"),
        "bar_hpaccess_potential": get_chart(df, "bar_hpaccess_potential"),
        "pie_hplevel": get_chart(df, "pie_hplevel"),
        "bar_hplevel_potential": get_chart(df, "bar_hplevel_potential"),
        "pie_title": get_chart(df, "pie_title"),
        "bar_title_potential": get_chart(df, "bar_title_potential"),
        # 'treemap_rsp_hosp_client':get_chart(df,'bar_line_potential_dist' ),
        "bar_dsm": get_chart(df, "bar_dsm"),
